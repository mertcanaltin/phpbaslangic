...
bkLib.onDomLoaded(function() {
  ...
  <form action="sayfaekle.php" method="post">
	...
	$sonuc->execute();
	echo("<div class='alert alert-success'>Kayıt ekleme Bbaşarılı olarak gerçekleşti. Sayfa Listesine yönlendiriliyorsunuz.</div>");
	header("refresh:5;url=sayfalistesi.php");
		}catch(PDOException $ex){//try bitti
		echo("<div class='alert alert-danger'>Kayıt eklemde Hata. Sayfa Listesine yönlendiriliyorsunuz.</div>");	
		header("refresh:5;url=sayfalistesi.php");	
		}
	}
